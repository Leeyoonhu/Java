$(document).ready(function(){
	...
	$("#googleLogin").on('click', function(){
		...
		location.href = "https://accounts.google.com/o/oauth2/v2/auth?client_id=407684725072-2ikndkuqcafeku5ufb4dvnm940t1d1v1.apps.googleusercontent.com&redirect_uri=http://localhost:8080/login&response_type=code&scope=email%20profile%20openid&access_type=offline"
	})
})