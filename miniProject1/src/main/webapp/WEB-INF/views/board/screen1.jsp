...
<c:forEach var="item" items="${bList}">
	<div style="width: 200px; height: 320px; display: inline-block; margin-left: 70px; border: 1px solid gray; box-sizing: border-box; border-radius: 3px;" >
		<c:choose>
			...
			<c:otherwise>
				<img alt="" src="/board/display?fileName=${item.imageFilePath}${item.imageFileName}" onerror="this.style.display='none'" onclick="document.getElementById('goScreenView2').click()" style="border-bottom: 1px solid gray; overflow: hidden; cursor: pointer;"> <br>
