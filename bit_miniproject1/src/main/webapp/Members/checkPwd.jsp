...
<div class="bodywash">
	<div class="card align-middle" style="width:25rem;">
		<div class="card-title" style="margin-top:30px;">
			...
			<h2 class="card-title" style="color:#f58b34;"><img src="https://i.ibb.co/Xbr9XFs/binocular.png" width="60px" height="60px"/>비밀번호 찾기</h2>
		</div>
      ...
      <form action="findPw" class="form-signin" method="POST">
        ...
        <div class="links">
            <a style="color : black" href="memberId">아이디 찾기</a> | <a style="color : black" href="memberLogin">로그인</a> | <a style="color : black" href="memberRegist">회원가입</a>
