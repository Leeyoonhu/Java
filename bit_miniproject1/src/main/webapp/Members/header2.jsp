...
<%} %>
<h1 style="text-align: center; font-weight:bold; font-size: 3.5em; position: relative; margin-top : 30px; color: white; cursor: pointer;" onclick="document.getElementById('jungunsi2').click()">
